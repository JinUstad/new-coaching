...
export const metadata: Metadata = {
  title: 'Our Courses - DevforDevs Academy',
  description: 'Explore professional tuition programs offered by DevforDevs. Master Web Development, Figma layouts, React Frontend, UI/UX designing, Backend database servers, Full-Stack engineering, and App Development.',
}
