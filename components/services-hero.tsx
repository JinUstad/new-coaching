    ...
    <section className="relative min-h-[60vh] flex items-center justify-center pt-32 pb-16 px-4 sm:px-6 lg:px-8 overflow-hidden bg-background">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        >
          ...
          >
            We build custom SaaS applications, design responsive layouts in Figma, compile technical search engine optimizations, and craft cinematic visual edits to grow your brand.
          </motion.p>
